...
const BASE_URL = trimTrailingSlash(process.env.DEEPSEEK_BASE_URL || DEFAULT_BASE_URL);
const MODEL = process.env.DEEPSEEK_MODEL || DEFAULT_MODEL;
const API_KEY = process.env.DEEPSEEK_API_KEY || "";
const TIMEOUT_MS = parseInt(process.env.DEEPSEEK_TIMEOUT_MS || String(DEFAULT_TIMEOUT_MS), 10);
